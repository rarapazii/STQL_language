...
/* package Stql-0.1.0.0 */
#ifndef VERSION_Stql
#define VERSION_Stql "0.1.0.0"
#endif /* VERSION_Stql */
#ifndef MIN_VERSION_Stql
#define MIN_VERSION_Stql(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Stql */
...
#define CURRENT_COMPONENT_ID "Stql-0.1.0.0-inplace-Stql"
